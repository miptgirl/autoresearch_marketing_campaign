...
- A tiny readability win: naming the linearized rate term `rate_excess` makes the `500 * cs_contacts - 21 * users <= 0` constraint easier to recognize without re-expanding the algebra inline.
